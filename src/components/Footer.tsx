  ...
  return (
    ...
    >
      <div className="relative h-[calc(100vh+600px)] -top-[100vh]">
        <div className="h-[600px] bg-[#122461] sticky top-[calc(100vh-600px)]">
          <div className='absolute pt-12 px-6 md:px-12 h-full w-full flex flex-col overflow-auto justify-between'>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 items-start max-w-[1440px] mx-auto'>

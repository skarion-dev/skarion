    ...
    <nav className="fixed bg-transparent top-5 inset-x-5 z-50">
        ...
        <div className="flex justify-between items-center h-16 bg-[#122461] opacity-90 text-white rounded-full shadow-2xl ring-1 ring-black/10 px-6">
          ...
          <div className="flex-shrink-0">
            <a href="#" className="inline-flex items-center justify-center group">
              <span className="inline-flex items-center justify-center size-10 rounded-full bg-white shadow transition-transform duration-700 ease-in-out group-hover:rotate-[360deg] will-change-transform">
          ...
          <div className="hidden md:block">
            <div className="ml-6 flex items-center space-x-8">
              ...
              <button
                onClick={copyEmail}
                className="ml-8 inline-flex items-center px-4 py-2 rounded-full bg-white text-black font-medium shadow hover:shadow-md transition-all duration-200"
              >
                {copied ? 'Copied ✅' : 'fire@email.com'}
              </button>
            </div>
          </div>
      ...
      >
        <div className="px-2 pt-2 pb-3 space-y-1 bg-black border-t border-gray-200">
          ...
          <button
            onClick={copyEmail}
            className="w-full text-left px-3 py-2 rounded-md text-base font-medium bg-[#c3ddf5] text-black font-medium hover:bg-red-400 hover:text-white transition-all duration-300 mt-2 flex items-center"
          >

...
export default function ContractForm({
  ...
  return (
    ...
    >
      ...
      <div>
          <Link
                href={!isFormValid || isPurchased || !courseFound ? "" : "https://outlook.office.com/book/SkarionConsultationCall@inuberry.com/?ismsaljsauthenabled"}
                rel="noopener noreferrer"
                className={`bg-black rounded-[12px] px-6 py-3 flex justify-center items-center gap-2 group transition-all duration-300 whitespace-nowrap ${!isFormValid || isPurchased || !courseFound ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
            >
                <p className="text-[#FFFFFF] text-[12px] sm:text-[15px] font-[500] flex">

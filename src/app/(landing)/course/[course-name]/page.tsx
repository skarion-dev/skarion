    ...
    return (
        ...
        <div className="w-[30%]">
            <div className="sticky top-[126px] rounded-[14px] bg-[#122461] w-full px-8 py-8">
                <div className="bg-[#ffffff] rounded-[14px] h-[200px]">

                </div>
                <p className="text-[24px] leading-[1.2] text-white mt-4 font-[500]">Outside Plant Engineering</p>
                <div className="mt-3 flex gap-3">
                    <p className="text-[20px] leading-[1.2] text-white line-through font-[500]">$500</p>

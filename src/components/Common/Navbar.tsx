    ...
    return (
        <div className="sticky top-4 z-30">
            ...
            onMouseLeave={() => setIsMenuOpen(false)}>
                <div className="lg:max-w-[1440px] sm:mx-auto  flex justify-between mt-4 mx- h-[70px] bg-[#FFFFFF] rounded-[12px] border border-[#EBEBEB] px-6">
                        ...
                        >
                            <div className="overflow-y-auto max-h-[65vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                {selectedMenu === "company" && (
                                    <div className="p-4 sm:p-6 col-span-1 md:col-span-2 lg:col-span-3">

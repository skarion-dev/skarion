...
export const metadata: Metadata = {
  ...
  description: "Skarion helps individuals gain the skills and experience needed to secure high-demand jobs through specialized, hands-on training in OSP, AutoCAD, and GIS.",
  keywords: [
    "Skarion",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Skarion - Advancing Careers Through Specialized Training",
      },
    ],
    locale: "en_US",
    type: "website",

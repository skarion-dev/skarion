...
export class CoursesService {
     ...
     * @throws ApiError
     */
    public static coursesControllerFindAll(): CancelablePromise<Array<CourseResponse>> {
     ...
     * @throws ApiError
     */
    public static coursesControllerGetMyCourses(): CancelablePromise<Array<CourseResponse>> {
        return __request(OpenAPI, {
            method: 'GET',
